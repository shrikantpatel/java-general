...
public class Word_Ladder {
    ...
    public void test1() {
        ...
        assertEquals(5, toTest.ladderLength(beginWord, endWord, wordList));
    }
    ...
    public void test2() {
        ...
        assertEquals(0, toTest.ladderLength(beginWord, endWord, wordList));
    }
    ...
    public void test4() {
        ...
        assertEquals(3, toTest.ladderLength(beginWord, endWord, wordList));
    }
    ...
    public void test7() {
        ...
        assertEquals(11, toTest.ladderLength(beginWord, endWord, wordList));
    }
}
